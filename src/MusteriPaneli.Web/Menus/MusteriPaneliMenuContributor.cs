...
namespace MusteriPaneli.Web.Menus;

public class MusteriPaneliMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public MusteriPaneliMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<MusteriPaneliResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                MusteriPaneliMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
